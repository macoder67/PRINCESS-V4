...
const ALIVE_IMG = "https://files.catbox.moe/73mlk5.jpg"; // Ensure this URL is valid
...
🤖 *AI Commands:*  
• *Macoder* - Generates an AI response.  
• *Macoderai* - Generates image response.  
