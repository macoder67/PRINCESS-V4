...
macoder({
    ...
    react: "✅",
    desc: "Get pairing code for Macoder bot",
    category: "download",
    use: ".pair +27656134XXX",
    filename: __filename
    ...
    try {
        ...
        const doneMessage = "> *PRINCESS PAIRING COMPLETED*";
